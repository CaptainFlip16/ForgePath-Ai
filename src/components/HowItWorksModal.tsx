        ...
        >
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 text-xs sm:text-sm">
              <div className="p-4 rounded-xl bg-indigo-500/5 border border-indigo-500/15 text-[var(--text-main)] text-xs leading-relaxed font-medium">
                ...
                {steps.map((item, idx) => {
                  ...
                  return (
                    <motion.div 
                      ...
                      className="flex items-start gap-4 p-4 rounded-xl bg-[var(--bg-hover)] border border-[var(--border-color)] transition-all hover:border-indigo-500/40 shadow-sm"
                    >
            ...
            <div className="px-6 py-4 border-t border-[var(--border-color)] bg-[var(--bg-header)] flex items-center justify-between gap-3 shrink-0">
              <div className="flex items-center gap-1.5 text-[11px] font-mono text-[var(--text-muted)] font-semibold">
